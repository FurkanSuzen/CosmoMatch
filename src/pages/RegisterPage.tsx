...
import { COUNTRIES_TR_SORTED } from "../lib/countries";
        ...
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-x-4 sm:gap-y-4">
          <div className="sm:col-span-1">
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-2.5 text-sm text-slate-100 outline-none transition focus:border-indigo-400/35 focus:ring-2 focus:ring-indigo-500/25 sm:py-3"
          ...
          <div className="sm:col-span-1">
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-2.5 text-sm text-slate-100 outline-none transition focus:border-indigo-400/35 focus:ring-2 focus:ring-indigo-500/25 [color-scheme:dark] sm:py-3"
              required
            />
          </div>
